...
export function Sidebar({ user }: { user: User }) {
  ...
  return (
    <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
      <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white border-r border-brand-border px-6 pb-4">
        {/* Logo */}
              ...
              return (
                <li key={item.name}>
                  <Link
                    href={item.href}
                    className={cn(
                      'group flex gap-x-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-all',
                      isActive
